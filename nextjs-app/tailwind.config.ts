...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "gradient-dark": "linear-gradient(135deg, #0f172a 0%, #1e293b 25%, #0f766e 75%, #064e3b 100%)",
        ...
        "gradient-accent": "linear-gradient(135deg, #a3e635 0%, #84cc16 50%, #65a30d 100%)",
        "gradient-glass": "linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 100%)",
      },
      boxShadow: {
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
        'glass-lg': '0 25px 45px -12px rgba(0, 0, 0, 0.25)',
        'neon': '0 0 20px rgba(163, 255, 18, 0.5)',
        'neon-lg': '0 0 40px rgba(163, 255, 18, 0.4)',
      },
      backdropBlur: {
        'xs': '2px',
      },
